...
//
// graphVert
// Adding each node as a vertex in the graph
//
void Nodes::graphVert(graph& G){
  // loops through each of the pairs in the MapNodes map and adds a vertex
  for(auto& pair : this->MapNodes){
